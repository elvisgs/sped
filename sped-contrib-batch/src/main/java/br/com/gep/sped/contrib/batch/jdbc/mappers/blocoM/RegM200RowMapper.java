...
import br.com.gep.sped.contrib.marshaller.registros.blocoM.RegM200;
...
@Component
@Lazy
public class RegM200RowMapper implements RowMapper<RegM200> {

    @Override
    public RegM200 mapRow(ResultSet rs, int rowNum) throws SQLException {
