...
@Getter
@Setter
public class RegM600 extends Registro {

    /**
     * Valor Total da Contribuição Não Cumulativa do Período  (recuperado do campo 13 do Registro M610, quando o campo COD_CONT for igual a 01, 02, 03, 04, 32 e 71)
     */
    @Field(at = 2)
    ...
    /**
     * Valor Total da Contribuição Cumulativa  do Período (recuperado do campo 13 do Registro M610, quando o campo COD_CONT for igual a 31, 32, 51, 52, 53, 54 e 72)
     */
    @Field(at = 9)
