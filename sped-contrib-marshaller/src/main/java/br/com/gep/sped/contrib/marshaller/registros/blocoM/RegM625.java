...
/**
 * M625 - Detalhamento do Ajuste da COFINS Apurada
 */
@Record
@Fields({
    @Field(at = 0, name = "inicioLinha"),
    @Field(at = 1, name = "reg", rid = true, literal = "M625"),
    @Field(at = 10, name = "fimLinha")
})
@Getter
@Setter
public class RegM625 extends Registro {

    /**
     * Detalhamento do valor da contribuição reduzida ou acrescida,informado no Campo 03 (VL_AJ) do registro M620
     */
    @Field(at = 2)
