...
public class RegM700 extends Registro {
    ...
    /**
     * Natureza do Crédito Diferido, vinculado a receita tributada no mercado interno, a descontar.
    ...
    /**
     * Periodo de apuração da contribuição social e dos créditos diferidos (MMAAAA)
     */
    @Field(at = 7)
