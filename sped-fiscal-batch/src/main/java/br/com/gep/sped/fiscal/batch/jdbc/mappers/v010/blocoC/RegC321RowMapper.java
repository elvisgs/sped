...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoC.RegC321;
...
@Component
@Lazy
public class RegC321RowMapper implements RowMapper<RegC321> {

    @Override
    public RegC321 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegC321 reg = new RegC321();
