...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoC.RegC510;
...
@Component
@Lazy
public class RegC510RowMapper implements RowMapper<RegC510> {

    @Override
    public RegC510 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegC510 reg = new RegC510();
