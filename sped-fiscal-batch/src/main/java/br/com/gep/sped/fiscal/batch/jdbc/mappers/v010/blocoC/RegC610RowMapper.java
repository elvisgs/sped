...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoC.RegC610;
...
@Component
@Lazy
public class RegC610RowMapper implements RowMapper<RegC610> {

    @Override
    public RegC610 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegC610 reg = new RegC610();
