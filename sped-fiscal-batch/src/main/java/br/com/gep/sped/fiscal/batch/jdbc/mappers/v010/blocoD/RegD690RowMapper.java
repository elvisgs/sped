...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoD.RegD690;
...
@Component
@Lazy
public class RegD690RowMapper implements RowMapper<RegD690> {

    @Override
    public RegD690 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegD690 reg = new RegD690();
