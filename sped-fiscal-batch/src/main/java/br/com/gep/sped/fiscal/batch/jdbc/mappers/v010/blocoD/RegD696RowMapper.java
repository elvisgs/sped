...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoD.RegD696;
...
@Component
@Lazy
public class RegD696RowMapper implements RowMapper<RegD696> {

    @Override
    public RegD696 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegD696 reg = new RegD696();
