...
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoE.RegE316;
...
@Component
@Lazy
public class RegE316RowMapper implements RowMapper<RegE316> {

    @Override
    public RegE316 mapRow(ResultSet rs, int rowNum) throws SQLException {
        RegE316 reg = new RegE316();
