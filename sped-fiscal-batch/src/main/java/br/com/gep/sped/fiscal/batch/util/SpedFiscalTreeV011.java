...
import br.com.gep.sped.fiscal.marshaller.registros.v010.bloco0.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoC.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoD.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoE.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoG.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoH.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.blocoK.*;
import br.com.gep.sped.fiscal.marshaller.registros.v010.bloco1.*;
...
import br.com.gep.sped.fiscal.marshaller.registros.v011.blocoE.RegE113;
...
import br.com.gep.sped.fiscal.marshaller.registros.v011.blocoK.*;
import br.com.gep.sped.fiscal.marshaller.registros.v011.bloco1.Reg1210;
import br.com.gep.sped.fiscal.marshaller.registros.v011.bloco1.Reg1923;
import br.com.gep.sped.marshaller.common.bloco9.*;
...
/**
 * Representa a árvore de registros do SPED Fiscal v011.
 */
@Component
public class SpedFiscalTreeV011 extends SpedTree {
    ...
    private void addBranchesBloco0() {
        ...
        addNode(RegNode.of(Reg0200.class/*v011*/).withParent(Reg0001.class).withChildren(
    ...
    private void addBranchesBlocoK() {
        ...
        addNode(RegNode.of(RegK100.class).withParent(RegK001.class).withChildren(
            ...
            RegNode.of(RegK210.class).withChildren(
                RegNode.of(RegK215.class)
            ),
            ...
            RegNode.of(RegK260.class).withChildren(
                RegNode.of(RegK265.class)
            ),
            RegNode.of(RegK270.class).withChildren(
                RegNode.of(RegK275.class)
            ),
            RegNode.of(RegK280.class)
        ));
