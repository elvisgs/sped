...
public class ItemReadersBloco1Config {
    ...
    public ItemStreamReader<Reg1001> reg1001ItemReader() {
        return itemReaderFactory.create(Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1010> reg1010ItemReader() {
        return itemReaderFactory.create(Reg1010.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1020> reg1020ItemReader() {
        return itemReaderFactory.create(Reg1020.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1100> reg1100ItemReader() {
        return itemReaderFactory.create(Reg1100.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1300> reg1300ItemReader() {
        return itemReaderFactory.create(Reg1300.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1500> reg1500ItemReader() {
        return itemReaderFactory.create(Reg1500.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1700> reg1700ItemReader() {
        return itemReaderFactory.create(Reg1700.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1800> reg1800ItemReader() {
        return itemReaderFactory.create(Reg1800.class, Reg1001.class);
    }

    @Bean
    public ItemStreamReader<Reg1900> reg1900ItemReader() {
        return itemReaderFactory.create(Reg1900.class);
    }
}
