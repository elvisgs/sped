...
public class Reg1100 extends RegBase {
    ...
    /**
     * Obtém Valor do Crédito apurado em Demonstrativo Dacon ou em Escrituração Fiscal Digital, em Período(s)  Anterior(es).
     */
    ...
    /**
     * Seta Valor do Crédito apurado em Demonstrativo Dacon ou em Escrituração Fiscal Digital, em Período(s)  Anterior(es).
     */
    ...
    /**
     * Obtém Valor de Crédito Extemporâneo Apurado (Registro 1101), referente a Período Anterior, Informado no Campo 02 - PER_APU_CRED
     */
    ...
    /**
     * Seta Valor de Crédito Extemporâneo Apurado (Registro 1101), referente a Período Anterior, Informado no Campo 02 - PER_APU_CRED
     */
