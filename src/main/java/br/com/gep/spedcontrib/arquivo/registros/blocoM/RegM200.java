...
@Record
@Fields({
    @Field(at = 0, name = "reg", rid = true, literal = "M200")
})
public class RegM200 {
    ...
    /**
     * Obtém Valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M210, quando o campo COD_CONT for igual a 01, 02, 03, 04, 32 e 71)
     */
    ...
    /**
     * Seta Valor Total da Contribuição Não Cumulativa do Período (recuperado do campo 13 do Registro M210, quando o campo COD_CONT for igual a 01, 02, 03, 04, 32 e 71)
     */
    ...
    /**
     * Obtém Valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M100)
     */
    ...
    /**
     * Seta Valor do Crédito Descontado, Apurado no Próprio Período da Escrituração (recuperado do campo 14 do Registro M100)
     */
    ...
    /**
     * Obtém Valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1100)
     */
    ...
    /**
     * Seta Valor do Crédito Descontado, Apurado em Período de Apuração Anterior (recuperado do campo 13 do Registro 1100)
     */
    ...
    /**
     * Obtém Valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M210, quando o campo COD_CONT for igual a 31, 32, 51, 52, 53, 54 e 72)
     */
    ...
    /**
     * Seta Valor Total da Contribuição Cumulativa do Período (recuperado do campo 13 do Registro M210, quando o campo COD_CONT for igual a 31, 32, 51, 52, 53, 54 e 72)
     */
