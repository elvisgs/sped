...
@Record
@Fields({
    @Field(at = 0, name = "reg", rid = true, literal = "P210")
})
public class RegP210 {
    ...
    /**
     * Obtém Número do processo, documento ou ato concessório ao qual o ajuste está vinculado, se houver
     */
    ...
    /**
     * Seta Número do processo, documento ou ato concessório ao qual o ajuste está vinculado, se houver
     */
